<x-guest-layout>
    <div class="h-screen  md:p-4">
        @if (Route::has('login'))
            <div class="hidden float-right px-6 py-4 sm:block">
                @auth
        ...
        <div class="p-2 md:p-10 space-y-10">
            <h1 class="text-center text-3xl font-bold">Duff's Back to School Fundraiser</h1>

            <div class="chart-wrapper p-8">
                <ul class="chart-y">
                    <li>$40,000</li>
                    <li>$30,000</li>
                    <li>$20,000</li>
                ...
                <ul class="chart-x">
                    <li id="bar" data-year="${{ $total }}">${{ $total }}</li>
                </ul>
            </div>

            {{-- donors --}}
            <div class="mt-10 shadow overflow-hidden sm:rounded-md">
                <ul role="list" class="grid md:grid-cols-3 border border-gray-100">
                    @foreach ($donations as $donation)
                        <li class="hover:bg-gray-100">
                            <div class="min-w-0 flex-1 flex items-center px-4 py-4 sm:px-6">
                                <div class="flex-shrink-0">
                                    <svg viewBox="0 0 100 100" class="w-14 h-14" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M11 66.5L89 66.5" fill="none" stroke="#45413c"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M6.5 66.5L9 66.5" fill="none" stroke="#45413c"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M91 66.5L93.5 66.5" fill="none" stroke="#45413c"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path
                                        ...
                                        <path
                                            d="M68.538,55.814H61.615a1.331,1.331,0,0,1-1.331-1.331V40.462a1.328,1.328,0,0,1,.479-1.022l4.313-3.595L69.39,39.44a1.328,1.328,0,0,1,.479,1.022V54.483A1.331,1.331,0,0,1,68.538,55.814Z"
                                            fill="none" stroke="#45413c" stroke-linecap="round"
